...
Public Class deleteStud
    ...
    Private Sub deleteStud_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub btnDelete_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnDelete.Click
        ...
        SQL = "DELETE FROM stud_section WHERE studId = '" & txtSearchStudId.Text & "' "
        SQL2 = "DELETE FROM enrolled_stud WHERE studId = '" & txtSearchStudId.Text & "' "

        If txtStudName.Text = "" And txtStudSection.Text = "" Then
            MessageBox.Show("Please choose a student to delete!")
        Else
            Dim msg As String = "Permanently remove " & txtStudName.Text & " from section " & txtStudSection.Text & ". Continue?"
            ...
            If (dgResult = 6) Then
                ...
                Try
                    ...
                    MessageBox.Show(txtStudName.Text & " was successfully deleted!")
    ...
    Private Sub txtSearchStudId_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtSearchStudId.Click
